                ...
                <div class="navi mt-1">
                    <a href="#!" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted text-hover-primary wrap-anywhere">
                                <?= $identity->email ?>
                            </span>
                        </span>
                    </a>
            ...
            <?= Html::a(<<< HTML
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Username & Role
            ...
            <?= Html::a(<<< HTML
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Personal & Social</div>
                    </div>
                </div>
            HTML, ['user/profile'], ['class' => 'navi-item']) ?>
