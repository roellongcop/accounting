...
/**
 * This is the model class for table "{{%payables}}".
 *
 * @property int $id
...
class Payable extends ActiveRecord
{
  ...
  /**
   * {@inheritdoc}
   * @return \app\models\query\PayableQuery the active query used by this AR class.
   */
  public static function find()
  {
    return new \app\models\query\PayableQuery(get_called_class());
  }
  ...
  {
    return Label::widget(['options' => App::params('payable_status')[$this->status]]);
  }
