...
class LegalDocumentSearchTest extends \Codeception\Test\Unit
{
    ...
    {
        $searchModel = new LegalDocumentSearch();
        $dataProviders = $searchModel->search(['LegalDocumentSearch' => ['keywords' => '']]);
    ...
    public function testSearchWithNoResult()
    {
        ...
        $dataProviders = $searchModel->search([
            'LegalDocumentSearch' => ['keywords' => 'qwertyuiopasdfghjkl234567890']
        ]);
