...
$this->registerCss(<<< CSS
  .field-payable-user_id {
    margin-bottom: 0 !important;
  }
CSS);

if (!App::identity()->can('index', 'payable')) return;
?>
...
<div class="card card-custom gutter-b card-stretch">
	<div class="card-header">
        ...
        <?php if (!App::identity('isClient')): ?>
          <div class="d-flex">
            <?= $form->bootstrapSelect($payable, 'user_id', $clients, [
            	'label' => false,
              'options' => [
	...
	<div class="card-body p-0 pt-5 ">
  	<?= App::ifElse(array_key_first($clients), fn ($id) => StackChart::widget([
  		'data_url' => Url::toRoute(['dashboard/filter-payable']),
  		'user_id' => $id,
			'additional_scripts' => <<< JS
				$('#payable-user_id').change(function() {
	...
	<div class="card-footer d-flex justify-content-between">
		<?= Html::a('Create New', ['payable/create'], [
			'class' => 'btn btn-success font-weight-bolder'
		]) ?>
		<?= Html::a('View All Payables', ['payable/index'], [
