...
$this->params['activeMenuLink'] = Url::toRoute(['user/profile']);
?>
<div class="user-profile-page">
	<div class="row">
			...
			<?php $this->beginContent('@app/views/layouts/_card_wrapper.php') ?>
					<div class="text-center mb-8">
						<div class="symbol symbol-60 symbol-circle symbol-xl-90">
							<div class="symbol-label" style="background-image:url(<?= Url::image($user->photo) ?>)"></div>
						...
						<span class="label label-light-<?= $user->isActive ? 'warning': 'danger' ?> label-inline font-weight-bold label-lg">
		...
		<div class="col-md-9">
			<?php $this->beginContent('@app/views/layouts/_card_wrapper.php') ?>
				<?= $this->render("accountant-profile/{$tab}", ['model' => $model]) ?>
			<?php $this->endContent(); ?>
		</div>
	</div>
</div>